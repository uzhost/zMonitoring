<?php
// index.php — Public landing page (Zangiota Exam Analytics)

declare(strict_types=1);

// --- Security headers (lightweight, public page safe defaults) ---
header('Content-Type: text/html; charset=utf-8');
header('X-Frame-Options: DENY');
header('X-Content-Type-Options: nosniff');
header('Referrer-Policy: same-origin');
// If your portal is HTTPS (recommended), uncomment this:
// header('Strict-Transport-Security: max-age=31536000; includeSubDomains; preload');

// Optional basic CSP for public page (no inline <script> needed except AOS init below)
// If you later add inline scripts, keep nonce-based CSP instead.
// header("Content-Security-Policy: default-src 'self' https:; img-src 'self' https: data:; style-src 'self' https: 'unsafe-inline'; script-src 'self' https: 'unsafe-inline'; font-src 'self' https: data:;");
...
<head>
  <meta charset="utf-8">
  <title><?= htmlspecialchars($schoolName) ?> — Natijalar va tahlil</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <!-- Bootstrap 5.3.8 + Icons 1.13.1 -->
  ...
  <meta name="description" content="Zangiota tuman ixtisoslashtirilgan maktabi — o‘quvchilar imtihon natijalari, fanlar kesimida taqqoslash va tahlil, dinamika va ko‘rsatkichlar.">
    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center gap-2">
          ...
          <div>
            <div class="fw-semibold"><?= htmlspecialchars($schoolName) ?></div>
        ...
        <div class="d-none d-md-flex align-items-center gap-2">
          <span class="badge badge-soft rounded-pill px-3 py-2">
            <i class="bi bi-shield-check me-1"></i> Xavfsiz ko‘rish
          </span>
          <a class="btn btn-ghost btn-sm px-3" href="#how">
            Qanday ishlaydi
          </a>
        </div>
      </div>
  ...
  <main class="pb-4">
    <div class="container">
        ...
        <div class="row align-items-center g-4">
          <div class="col-lg-7">
            ...
            <h1 class="display-6 fw-bold mb-3">
              Imtihon natijalari va fanlar bo‘yicha tahlil — barchasi bitta joyda
            </h1>

            <p class="lead lead-muted mb-4">
              Ushbu portal orqali o‘quvchilar natijalarini ko‘rishingiz, fanlar kesimida taqqoslashingiz,
              kuchli va rivojlantirish kerak bo‘lgan yo‘nalishlarni aniqlashingiz mumkin.
              Natijalar jadval ko‘rinishida, trend va taqsimot tahlillari bilan birga taqdim etiladi.
            </p>

            <div class="d-flex flex-column flex-sm-row gap-2">
              <a href="/results.php" class="btn btn-primary btn-cta btn-lg">
            ...
            <div class="mt-4 d-flex flex-wrap gap-3 text-secondary tiny">
              <span><i class="bi bi-check2-circle me-1"></i> Fanlar bo‘yicha solishtirish</span>
              <span><i class="bi bi-check2-circle me-1"></i> O‘sish/pasayish dinamikasi</span>
              <span><i class="bi bi-check2-circle me-1"></i> Filtrlar va qidiruv</span>
              <span><i class="bi bi-check2-circle me-1"></i> Print-friendly ko‘rinish</span>
            </div>
          </div>
              ...
              <div class="row g-3">
                <div class="col-6">
                  <div class="stat p-3">
                    ...
                    <div class="text-secondary tiny">Choraklar bo‘yicha</div>
                  </div>
                </div>
                <div class="col-6">
                  <div class="stat p-3">
                    ...
                    <div class="text-secondary tiny">Sinflar bo‘yicha</div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="stat p-3">
                    <div class="d-flex align-items-center justify-content-between">
                      <div>
                        <div class="text-secondary tiny mb-1">Natijalarni ko‘rish uchun</div>
                        <div class="fw-semibold">“Natijalarni ko‘rish” tugmasini bosing</div>
                      </div>
                    ...
                    <div class="mt-3 text-secondary tiny">
                      Eslatma: Portal faqat natijalarni ko‘rsatish va tahlil qilish uchun mo‘ljallangan.
                     </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row g-3">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
            <div class="feature-card p-4">
              ...
              <p class="text-secondary mb-0">
                Sinf, fan, imtihon/chorak va boshqa mezonlar bo‘yicha natijalarni tez toping va solishtiring.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="80">
            <div class="feature-card p-4">
              ...
              <p class="text-secondary mb-0">
                Chorak va fanlar bo‘yicha o‘sish/pasayish, foiz o‘zgarishlari va progress indikatorlarini ko‘ring.
              </p>
            </div>
          </div>
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="160">
            <div class="feature-card p-4">
              ...
              <p class="text-secondary mb-0">
                Natijalar taqsimoti, fanlar kesimidagi ko‘rsatkichlar va umumiy xulosalarni qulay formatda oling.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how" class="feature-card p-4 p-md-5 mb-4" data-aos="fade-up">
        <div class="row align-items-center g-4">
          <div class="col-lg-6">
            ...
            <p class="text-secondary mb-0">
              Portal o‘quvchilar natijalarini imtihonlar bo‘yicha jamlaydi va fanlar kesimida tahlil qiladi.
              Siz kerakli sinfni tanlaysiz, o‘quvchini tanlaysiz va natijalarni jadval hamda tahliliy ko‘rinishda ko‘rasiz.
            </p>
            ...
            <div class="mt-4">
              <div class="d-flex gap-3 align-items-start mb-3">
                ...
                <div>
                  ...
                  <div class="text-secondary tiny">Natijalar bo‘limi orqali ko‘rish rejimida ochiladi.</div>
                </div>
              </div>
              ...
              <div class="d-flex gap-3 align-items-start mb-3">
                ...
                <div>
                  ...
                  <div class="text-secondary tiny">Sinf va o‘quvchini tanlang, fan bo‘yicha tahlilni ko‘ring.</div>
                </div>
              </div>
              ...
              <div class="d-flex gap-3 align-items-start">
                ...
                <div>
                  ...
                  <div class="text-secondary tiny">Trend, o‘zgarishlar va ko‘rsatkichlarni bir sahifada oling.</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6">
            <div class="p-4 rounded-4 border" style="background: rgba(255,255,255,.65);">
              <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge text-bg-light border">Qo‘llanma</span>
              </div>

              <ul class="text-secondary mb-0">
                <li class="mb-2">Ballar 0 dan 40 gacha bo‘lgan tizimda ko‘rsatiladi.</li>
                <li class="mb-2">Natijalar faqat ko‘rish va tahlil qilish uchun mo‘ljallangan.</li>
                <li class="mb-2">Agar natija chiqmasa, sinf tanlovi va o‘quvchi ma’lumotlarini tekshiring.</li>
                <li class="mb-0">Savollar bo‘lsa, maktab mas’ul xodimiga murojaat qiling.</li>
              </ul>

              <div class="mt-4 d-grid">
                <a href="/results.php" class="btn btn-primary btn-lg btn-cta">
                  <i class="bi bi-box-arrow-in-right me-2"></i>
                  Natijalarni ko‘rish sahifasiga o‘tish
                </a>
              </div>
            </div>
          </div>
      ...
      <section class="text-center text-secondary tiny pb-2" data-aos="fade-up" data-aos-delay="80">
        ...
        <div class="mb-2">
          © <?= $year ?> <?= htmlspecialchars($schoolName) ?>. Barcha huquqlar himoyalangan.
        </div>
        <div>
          Powered by
